...
{
    public partial class BIPeriodicLog_and_ApiUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEkium = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BIPeriodicLogs", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActEntities", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ActEntities_Acts_ActID",
                        column: x => x.ActID,
                        principalTable: "Acts",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ActEntityID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActEntityRoles", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ActEntityRoles_ActEntities_ActEntityID",
                        column: x => x.ActEntityID,
                        principalTable: "ActEntities",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ActEntities_ActID",
                table: "ActEntities",
                column: "ActID");

            migrationBuilder.CreateIndex(
                name: "IX_ActEntityRoles_ActEntityID",
                table: "ActEntityRoles",
                column: "ActEntityID");
