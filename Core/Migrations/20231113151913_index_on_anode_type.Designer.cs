...
namespace Core.Migrations
{
    ...
    [Migration("20231113151913_index_on_anode_type")]
    partial class index_on_anode_type
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.StationCycles.Models.DB.S3S4Cycles.S3S4Cycle", b =>
                {
                    ...
                    b.Property<int>("MatchingCamera1")
                        .HasColumnType("int")
                        .HasColumnName("S3S4Cycle_MatchingCamera1");

                    b.Property<int>("MatchingCamera2")
                        .HasColumnType("int")
                        .HasColumnName("S3S4Cycle_MatchingCamera2");
            ...
            modelBuilder.Entity("Core.Entities.Anodes.Models.DB.Anode", b =>
                {
                    b.HasOne("Core.Entities.StationCycles.Models.DB.S1S2Cycles.S1S2Cycle", "S1S2Cycle")
                        .WithOne("Anode")
