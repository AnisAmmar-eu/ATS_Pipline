namespace Core.Shared.Models.SignalR
{
		...
		where T : notnull
    {
        ...
        public IEnumerable<string> GetConnections(T key)
        {
            ...
            return _connections.TryGetValue(key, out HashSet<string>? connections) ? connections : Enumerable.Empty<string>();
        }
        ...
        public int GetConnectionsCount()
        {
            ...
            foreach (HashSet<string> values in _connections.Values)
            {
                count += values.Count;
            }
            return count;
