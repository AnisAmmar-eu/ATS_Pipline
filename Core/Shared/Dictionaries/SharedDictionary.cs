...
{
	public static readonly string[] OTC_INCLUDES =
	{
		"LossIssueType"
	};

	public static readonly string[] MATERIAL_C_INCLUDES =
	{
	...
	public static readonly string[] AREA_INCLUDES =
	{
		"Parent"
	};

	public static readonly string[] WORKING_ORDER_INCLUDES =
	{
	...
	public static readonly string[] WORKING_ORDER_KPI =
	{
		"WorkingOrder"
	};

	public static readonly string[] SCHEDULE_C_INCLUDES =
	{
		"St_Design"
	};

	public static readonly string[] SCHEDULE_I_INCLUDES =
	{
		"Equipment_I",
	...
	public static readonly string[] SHIFT_KPI_INCLUDES =
	{
		"ShiftI"
	};

	public static readonly string[] SHIFT_C_INCLUDES =
	{
		"Schedule_C",
		"St_Design",
		"St_Shift"
	...
	public static readonly string[] SHIFT_I_INCLUDES =
	{
	...
	public static readonly string[] LOSS_ISSUE_INCLUDES =
	{
		"LossReason",
		"EquipmentI",
		"LossIssueType",
	...
	public static readonly string[] LOSS_REASON_RELATION_INCLUDES =
	{
		"LossReason",
		"LossReasonTree"
	};

	public static readonly string[] LOSS_REASON_TREE_INCLUDES =
	{
		"St_Design.C_Langs.Language"
	};

	public static readonly string[] OPERATION_C_INCLUDES =
	{
	...
	public static readonly string[] OPERATION_I_INCLUDES =
	{
	...
	public static readonly string[] STEP_C_INCLUDES =
	{
	...
	public static readonly string[] STEP_I_INCLUDES =
	{
		"St_Exe.C_Langs.Language",
		"St_ExeClose.C_Langs.Language",
		"StatusConformity.C_Langs.Language",
	...
	public static readonly string[] FORM_C_INCLUDES =
	{
	...
	public static readonly string[] FORM_I_INCLUDES =
	{
		"St_Exe.C_Langs.Language",
		"StatusConformity.C_Langs.Language",
	...
	public static readonly string[] FIELD_C_INCLUDES =
	{
	...
	public static readonly string[] FIELD_I_INCLUDES =
	{
		"StatusConformity.C_Langs.Language",
		"Value.Field_CSelect_Option"
	};

	public static readonly string[] EQUIPMENT_C_INCLUDES =
	{
		"Type.C_Langs.Language",
		"St_Design.C_Langs.Language",
	...
	public static readonly string[] EQUIPMENT_I_INCLUDES =
	{
	};

	public static readonly string[] KPI_LOSSISSUES_INCLUDES =
	{
		"EquipmentI"
	};

	public static readonly string[] KPI_INCLUDES =
	{
		"Type.C_Langs.Language",
		"WorkingOrder",
		"ActivityState"
	...
	public static readonly string[] EQUIPMENT_KPI_INCLUDES =
	{
	};
}