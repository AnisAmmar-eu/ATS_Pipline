namespace Core.Entities.KPI.KPICs.Dictionaries;

public static class KPICRID
{
	// == Station cycles for sign / match graphs ==
	public const string StationCycleMatched = "StationCycleMatched";
	...
	public const string D20Anodes = "D20Anodes";
	public const string DXAnodes = "DXAnodes";
}